#define BLOCK_SIZE_X 512 //cuda block size of join and count kernel 
#define PART_C_NUM 512   //cuda block size of hash partition count
#define PER_TH 20000        //the number of tuple per one thread of hash partition 
