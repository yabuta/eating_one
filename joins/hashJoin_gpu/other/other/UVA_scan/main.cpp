...
int main(int argc, char **argv)
{
    ...
    */
    ...
    for(uint arrayLength = MIN ; arrayLength <= MAX ; arrayLength <<= 1){
      ...
      checkCudaErrors(cudaHostAlloc((void **)&d_Input,arrayLength*sizeof(uint),cudaHostAllocDefault));
      checkCudaErrors(cudaHostAlloc((void **)&d_Output,arrayLength*sizeof(uint),cudaHostAllocDefault));
