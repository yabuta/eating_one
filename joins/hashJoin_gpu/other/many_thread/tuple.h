...
#define PER_TH 5000        //the number of tuple per one thread of hash partition 
#define B_ROW_NUM 3072      //the number of sub left tuple per one block in join and count kernel
