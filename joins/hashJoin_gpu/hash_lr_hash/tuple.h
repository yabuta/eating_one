...
#define RIGHT_PER_TH 65536       //the number of tuple per one thread of hash partition 
#define B_ROW_NUM 32      //the number of sub left tuple per one block in join and count kernel
