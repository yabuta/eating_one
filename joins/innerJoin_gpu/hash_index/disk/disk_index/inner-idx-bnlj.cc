...
#define LEFT_FILE "/home/yabuta/JoinData/hash-index/gpu/left_table.out"
#define RIGHT_FILE "/home/yabuta/JoinData/hash-index/gpu/right_table.out"
#define INDEX_FILE "/home/yabuta/JoinData/hash-index/gpu/index.out"
...
int IndexJoin(
              ...
              CUdeviceptr buckArray_dev,
              CUdeviceptr idxcount_dev
){
...
void join(){
  ...
  CUdeviceptr rt_dev,bucket_dev,buckArray_dev,idxcount_dev;
  char fname[256];
  const char *path=".";
  ...
  while(1){
    ...
    jt_size = IndexJoin(function,c_function,rt_dev,bucket_dev,buckArray_dev,idxcount_dev);
